...
export {default as BankDetailApproval } from "./AdminCompliance/BankDetailApproval";
export {default as AccountBlockDisputeList } from "./AdminCompliance/AccountBlockDisputeList";
export {default as Index} from "./AffiliatePanel/Index";
export {default as UserBanksNameList} from "./User/UserBanksNameList";
